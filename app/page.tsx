...
const Login = () => {
  ...
  const [userData, setUserData] = useState(null); // to store in React state too
  ...
  const LoginWithMySQL = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setError1(result.error || "Invalid login credentials");
        toast.error(result.error || "Invalid login credentials");
        return;
      }

      // ✅ Save login credentials (except password) to localStorage + state
      const userInfo = {
        id: result.user.id,
      ...
      <body className="bg-dark">
        ...
        <div className="authentication-basic-background">
          <Image
            ...
            }/assets/images/media/backgrounds/9.png`}
            alt=""
          />
        </div>
        <ParticleCard />
          ...
          <Row className="justify-content-center align-items-center authentication authentication-basic h-100">
            <Col xxl={4} xl={5} lg={6} md={6} sm={8} className="col-12">
              <Tab.Container defaultActiveKey={"react"}>
                <Nav
                  variant="pills"
                  className="justify-content-center authentication-tabs mt-3"
                >
                  <Nav.Item>
                ...
                <Card className="custom-card border-0 my-4">
                  <Tab.Content className="">
                    ...
                    <Tab.Pane eventKey="firebase" className="border-0">
                      <Card.Body className="p-sm-5 ">
                        <div className="mb-4">
                          {err && <SpkAlerts variant="danger">{err}</SpkAlerts>}
                          <Link scroll={false} href="/dashboards/sales">
                            <Image
                              fill
                              src={`${
                          ...
                          <Col xl={12} className="mb-2">
                            ...
                            <div className="position-relative">
                              ...
                              <Link
                                ...
                                href="#!"
                                onClick={() =>
                                  togglePasswordVisibility("passwords")
                                }
                                className="show-password-button text-muted"
                                id="button-addon2"
                              >
