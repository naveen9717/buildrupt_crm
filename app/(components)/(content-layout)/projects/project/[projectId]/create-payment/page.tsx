...
const CreatePayment: React.FC<CreateProjectProps> = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_URL}/api/projects/project/${projectId}/create-payment`,
        {
          method: "POST",
      ...
      toast("Created Payment successfully!");
    } catch (error) {
      console.error(error);
