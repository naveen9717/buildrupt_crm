...
const CreateShoot: React.FC<CreateProjectProps> = () => {
  const DaySlot = [
  ...
  const [form2Rows, setForm2Rows] = useState([
    { photo_crew: "", photo_role: "", dayslot: "" },
  ]);

  const [form3Rows, setForm3Rows] = useState([
    { video_crew: "", video_role: "", dayslot: "" },
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast("Submitted Shoots successfully!");
    } catch (error) {
      console.error(error);
  ...
  return (
    <Fragment>
      ...
      <Seo title="Create Shoots" />

      <Pageheader
        title="Dashboards"
        subtitle="Projects"
        currentpage="Create Shoots"
        activepage="Create Shoots"
      />
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <div className="card-title">CREATE SHOOT</div>
            </Card.Header>
            <Card.Body>
                ...
                <div className="row gy-3">
                  ...
                  <div className="row gy-3 mt-1">
                    ...
                    <p className="mt-0 mb-0">
                      Add your Photographer crew here and assign them roles.
                    </p>
                        ...
                        <tr key={idx}>
                          ...
                          <td className="text-center">
                            <Row>
                              <SpkButton
                                Buttonvariant=""
                                onClickfunc={() => removeForm4Row(idx)}
                                Customclass="btn btn-danger-light btn-icon ms-1 btn-sm task-delete-btn"
                              >
                                <i className="ri-delete-bin-5-line"></i>
                              </SpkButton>
