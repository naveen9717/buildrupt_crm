...
const CreatePhoto: React.FC<CreateProjectProps> = () => {
  ...
  return (
    <Fragment>
      ...
      <Pageheader
        title="Dashboards"
        subtitle="Crews"
        currentpage="Create Photo Crew"
        activepage="Create Photo Crew"
      />
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <div className="card-title">Create Photo Crew</div>
            </Card.Header>
            <Card.Body>
