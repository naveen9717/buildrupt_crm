...
const PhotoTables: React.FC<DataTablesProps> = () => {
  ...
  const columns = [
    ...
    {
      name: "HALF DAY COST",
      selector: (row) => `₹ ${row.half.toLocaleString("en-IN")}`,
      sortable: true,
    },
    {
      name: "FULL DAY COST",
      selector: (row) => `₹ ${row.full.toLocaleString("en-IN")}`,
      sortable: true,
    },
    {
      name: "HALF + FULL DAY COST",
      selector: (row) => `₹ ${row.halffull.toLocaleString("en-IN")}`,
      sortable: true,
    },
    {
      name: "STATUS",
