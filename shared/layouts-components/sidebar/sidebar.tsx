      ...
      >
        ...
        <div className="main-sidebar-header">
          ...
          >
            ...
            <Image
              fill
              src="https://nextjs.spruko.com/bootstrap/app-router/vyzor-ts/preview/assets/images/brand-logos/toggle-dark.png"
              alt="logo"
                ...
                <ul className="slide-menu child1 doublemenu_slide-menu">
                  <li className="text-center p-3 text-fixed-white">
                    ...
                    <div className="d-flex flex-column align-items-center justify-content-between h-100">
                      <div className="fs-15 fw-medium">Dashboard</div>
                      <div>
