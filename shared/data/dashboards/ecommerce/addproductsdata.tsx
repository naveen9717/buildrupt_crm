...
export const Sizeselect: Select[] = [
...
export const Categoryselect: Select[] = [
...
export const Genderselect: Select[] = [
    { value: "Select", label: "Select" },
    { value: "All", label: "All" },
...
export const Colorselect: Select[] = [
...
export const Availableselect: Select[] = [
    { value: "Select", label: "Select" },
    { value: "In Stock", label: "In Stock" },
    { value: "Out Of Stock", label: "Out Of Stock" }
];

export const Publishselect: Select[] = [
    { value: "Select", label: "Select" },
    { value: "Published", label: "Published" },
    { value: "Scheduled", label: "Scheduled" }
];

export const Productselect: Select[] = [
