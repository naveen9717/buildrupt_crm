          ...
          <div className="card custom-card featured-jobs">
            <div className="card-body">
              <div className="btn-list float-end">
                ...
                <Link scroll={false} href="#!" className="avatar avatar-sm avatar-rounded bg-light text-default"><span><i className="bi bi-heart"></i></span></Link>
                </SpkTooltips>
                <SpkTooltips placement="top" title="Featured Jobs">
                <Link scroll={false} href="#!" className="avatar avatar-sm avatar-rounded bg-warning-transparent"><span><i className="bi bi-star-fill"></i></span></Link>
                </SpkTooltips>
              </div>
              <div className="d-flex flex-wrap gap-2 mb-3">
                ...
                <div className="ms-2">
                  <h5 className="fw-medium mb-0 d-flex align-items-center">
                    <Link scroll={false} href="#!">{badge.title}</Link>
                  </h5>
              ...
              <div className="popular-tags mb-3">
                <Link scroll={false} href="#!" className="badge rounded-pill bg-light text-default me-1">
