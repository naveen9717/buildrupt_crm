...
export const dashboardCards: DashboardCard[] = [
  {
    ...
    svgIcon: (
      ...
      >
        ...
        <g>
          <path d="M14,2H6C4.9,2,4.01,2.9,4.01,4L4,20c0,1.1,0.89,2,1.99,2H18c1.1,0,2-0.9,2-2V8L14,2z M10.94,18L7.4,14.46l1.41-1.41 l2.12,2.12l4.24-4.24l1.41,1.41L10.94,18z M13,9V3.5L18.5,9H13z"></path>
        </g>
      </svg>
    ),
    svgColor: "primary",
  ...
  },
  {
    ...
    svgIcon: (
      ...
      >
        ...
        <g>
          <path d="M6,2l0.01,6L10,12l-3.99,4.01L6,22h12v-6l-4-4l4-3.99V2H6z M16,16.5V20H8v-3.5l4-4L16,16.5z"></path>
        </g>
      </svg>
    ),
    svgColor: "secondary",
...
export const Recentupdates: UpdateItem[] = [
  {
    ...
    description:
      "The redesign for NovaStream has been successfully completed. The new website is now live and accessible for users.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Ongoing work to optimize backend services, particularly in trip request handling and driver location updates.",
  },
  {
